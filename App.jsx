          ...
          <div className="bg-white rounded-[3.5rem] w-full max-w-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={addItem} className="p-12 space-y-10">
              <div className="space-y-3">
                ...
                <input required name="name" className="w-full p-6 bg-slate-50 border border-slate-100 rounded-[1.5rem] outline-none focus:ring-4 focus:ring-indigo-50 transition-all text-xl font-bold" placeholder="例: インターロン 2/0号" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-10">
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] ml-1">数量</label>
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] ml-1">登録日</label>
          ...
          <div className="bg-white rounded-[3.5rem] w-full max-w-xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-12 duration-400">
            ...
            <form onSubmit={recordUsage} className="p-12 space-y-10">
              <div className="grid grid-cols-2 gap-10">
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] ml-1">使用日</label>
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  ...
                  placeholder="例: 衣服のボタンの光沢を表現するために使用..."
                ></textarea>
              </div>
